    ...
    return (
        <div className="w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg">
            ...
            <div className="flex items-center">
                <h2 className="text-3xl font-bold mr-4 sm:text-4xl">BRAND.</h2>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8' }>
                    ...
                    <li className="border-b-2 border-zinc-300 w-full"><Link onClick={handleClose} to="about" smooth={true} offset={-170} duration={500}>About</Link></li>

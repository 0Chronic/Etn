...
import bgImd from '../assects/cyber-bg.png'
...
const Hero = () => {
    return (
        ...
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
            ...
            <button className="py-4 px-6 sm:w-[60%]">Get Started</button>
        </div>

        <div>
            <img className="w-full" src={bgImd} />
        </div>
        ...
        <div className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[-5%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl   ">
            ...
            <p className="flex px-4 py-2 text-slate-500"><CloudUploadIcon className="h-6 text-indigo-600"/>App Secutity</p>
